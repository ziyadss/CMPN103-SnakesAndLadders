...
Player* CardEleven::pPlayerOwner = NULL;
...
void CardEleven::ReadCardParameters(Grid* pGrid) {
	...
	if (price == 0 && fees == 0) {
		out->PrintMessage("New CardEleven: Enter its price...");
...
void CardEleven::Save(ofstream& OutFile, int Type, string fname)
{
	if (Type != 2)
		return;
...
void CardEleven::Load(ifstream& InFile, int Type, string fname)
{
	if (Type != 2)
		return;
	int cellNum;
