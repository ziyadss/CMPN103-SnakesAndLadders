...
public:
	...
	//Type 0=ladder , 1= snake , 2 = card
	virtual void Save(ofstream& OutFile, int Type, string fname) = 0;	// Saves the GameObject parameters to the file
	virtual void Load(ifstream& InFile, int Type, string fname) = 0;	// Loads and Reads the GameObject parameters from the file
